...
const REAL_TEAMS_ISRAEL = [
  ...
  'מכבי נתניה', 'הפועל ירושלים', 'הפועל חיפה', 'בני סכנין', 'מ.ס אשדוד', 
  'הפועל חדרה', 'מכבי פתח תקווה', 'מכבי בני ריינה', 'הפועל פתח תקווה', 
  'עירוני קרית שמונה', 'עירוני טבריה', 'הפועל רמת גן', 'בית"ר ים', 'בני יהודה',
  'הפועל עכו', 'הפועל כפר סבא', 'הפועל נוף הגליל', 'הפועל ראשון לציון',
  'מכבי יפו', 'מכבי הרצליה', 'הפועל אום אל פאחם', 'הפועל עפולה', 'סקציה נס ציונה', 'חופשי'
];
