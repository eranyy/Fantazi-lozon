...
import { ScrollText, Trophy, LayoutTemplate, UserCheck, ShieldAlert } from 'lucide-react';
import { ALLOWED_FORMATIONS } from '../../constants/leagueConstants';

export const LeagueRulesSubTab: React.FC = () => {
  return (
