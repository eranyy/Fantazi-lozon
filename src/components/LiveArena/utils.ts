...
import { LiveArenaProps } from './types';
export type { LiveArenaProps };

export const TEAM_NAMES: Record<string, string> = { tumali: 'תומאלי', tampa: 'טמפה', pichichi: "פיצ'יצ'י", hamsili: 'חמסילי', harale: 'חראלה', holonia: 'חולוניה' };
...
export const getNormalizedTeamId = (nameOrId: string) => {
...
export const isPosMatch = (pPos: string, category: string) => {
...
export const getFormation = (lineup: any[]) => {
